...
(* OASIS_START *)
(* DO NOT EDIT (digest: 21eb29a68f1547c53210de55d2cbd2db) *)
(*
...
let setup_t =
  {
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage ("ppx_tools.metaquot", None);
                           InternalLibrary "pendulum_compiler"
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_interface_patterns =
                        [
     ...
     oasis_version = "0.4.7";
     oasis_digest = Some "L\184|\241nO\238q\155\238Njs\002\240\018";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
