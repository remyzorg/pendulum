...
(* OASIS_START *)
(* DO NOT EDIT (digest: 669769702d0108b9cca723f7aa06485e) *)
(*
...
let setup_t =
  {
            ...
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$test_lang_bin", []))];
            ...
            [
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules =
                        ["Interp"; "Runtime_ast"; "Runtime_misc"; "Machine"];
                      lib_pack = true;
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Utils"; "Ast"; "Grc"; "Sync2ml"];
                      lib_pack = true;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "pendulum";
                      lib_findlib_name = None;
                      lib_findlib_containers = []
                   });
               Executable
                 ({
                     cs_name = "ppx_pendulum";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = false; exec_main_is = "ppx_pendulum.ml"});
               Executable
                 ({
                     cs_name = "test_ppx";
                     cs_data = PropList.Data.create ();
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           InternalLibrary "pendulum"
                        ];
                      bs_build_tools =
                        [
                           ExternalTool "ocamlbuild";
                           InternalExecutable "ppx_pendulum"
                        ];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "test_lang.ml"});
               Test
                 ({
                     cs_name = "test_pendulum";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "%V\011\149q\240\163D /\201E\211{\0015";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
