...
(* OASIS_START *)
(* DO NOT EDIT (digest: 263b253a77c32802ea86189af21a5d9d) *)
(*
...
let setup_t =
  {
            ...
            [
               ...
               Flag
                 ({
                   ...
                   {
                      flag_description =
                        Some "build and install react related exemples";
                      flag_default = [(OASISExpr.EBool true, false)]
                   });
               Flag
                 ({
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules =
                        ["Runtime_ast"; "Runtime_misc"; "Signal"; "Program"];
                      lib_pack = true;
               ...
               Library
                 ({
                   ...
                   },
                   {
                      ...
                      lib_findlib_name = Some "compiler";
                      lib_findlib_directory = None;
                      lib_findlib_containers = []
                   });
               Library
                 ({
                   ...
                   },
                   {
                      ...
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "pendulum";
                      lib_findlib_name = Some "rml_backend";
                      lib_findlib_directory = None;
                      lib_findlib_containers = []
                   });
               Library
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "ppx_pendulum_ex.ml"});
               Executable
                 ({
                     cs_name = "test_ppx";
                     cs_data = PropList.Data.create ();
     ...
     oasis_digest =
       Some "\138\255\020C\133\207\011\152D\128\154\222\155\001\208\148";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
